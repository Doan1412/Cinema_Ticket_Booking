    ...
    <div>
        ...
        <div class="ctn">
            ...
            <ol class="flex items-center w-full">
                ...
                <li class="flex items-center w-full text-blue-600 dark:text-blue-500 " v-if="step == 3 || step == 4">
                    <span
            ...
            <Payment v-if="step == 3" @step="handlePaymentInfo"></Payment>
            <Ticket :listSeat="listSeat" :showId="showChoice.id" :movieId="id" v-if="step == 4" />
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    components: { TimeSelect, SeatSelete, Ticket, Payment }
}
</script>
<style>
.head {
