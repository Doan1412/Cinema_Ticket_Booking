<template>
    <div>
        ...
        <div class="ctn">
            ...
            <ol class="flex items-center w-full">
                ...
                <li
                class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700" v-if="step==1">
                <span
    ...
    <li
    class="flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-blue-100 after:border-4 after:inline-block dark:after:border-blue-800" v-else>
    <span
    class="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-800 shrink-0">
    <svg class="w-3.5 h-3.5 text-blue-600 lg:w-4 lg:h-4 dark:text-blue-300" aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
...
<li 
class="flex items-center w-full text-blue-600 dark:text-blue-500 " v-if="step==3">
<span
class="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0">
<svg class="w-3.5 h-3.5 text-blue-600 lg:w-4 lg:h-4 dark:text-blue-300" aria-hidden="true"
xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
d="M1 5.917 5.724 10.5 15 1.5" />
...
<li class="flex items-center w-full" v-else>
    <span
    class="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0">
    <svg class="w-4 h-4 text-gray-500 lg:w-5 lg:h-5 dark:text-gray-100" aria-hidden="true"
...
import SeatSelete from './seatSelete.vue';
...
export default {
    ...
    methods: {
        handleShowChoice(choice) {
            this.showChoice = choice;
            this.step = 2;
        },
        handleSeatChoice(listSeat) {
            this.listSeat = listSeat;
            console.log(this.listSeat);
            this.step = 3;
        }
    },
    components: { TimeSelect, SeatSelete, Payment }
}
</script>
<style>
.head {
