        ...
        <div class="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
            ...
            <div class="overflow-y-auto overflow-x-hidden flex-grow">
                <ul class="flex flex-col py-4 space-y-1">
                    ...
                    <li class="px-5">
                        <div class="flex flex-row items-center h-8">
                            <div class="text-sm font-light tracking-wide text-gray-500">Movie</div>
                        </div>
                    </li>
                    <li>
                        <a href="/movie"
...
export default{
    methods: {
        async logout() {
            try {
                localStorage.clear(); // clear local storage to log out user from all sessions and redirect them back
